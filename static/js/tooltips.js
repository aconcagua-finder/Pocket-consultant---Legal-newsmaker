    ...
    init() {
        ...
        this.tooltipData = {
            ...
            'temperature': {
                ...
                text: 'Контролирует случайность и креативность ответов модели. Низкие значения дают предсказуемые результаты, высокие – более творческие и разнообразные ответы.',
                example: '0.0 = максимальная точность<br>0.7 = оптимальный баланс<br>2.0 = максимальная креативность',
                type: 'info'
            },
            'top-p': {
                title: 'Top P (Nucleus Sampling)',
                text: 'Альтернативный метод контроля случайности ответов. Ограничивает выбор токенов до суммарной вероятности P. Используйте либо Temperature, либо Top P, не оба сразу.',
                example: '0.1 = только самые вероятные токены<br>0.9 = широкий выбор токенов<br>1.0 = все доступные токены',
                type: 'info'
            },
            'presence-penalty': {
                title: 'Presence Penalty',
                text: 'Штраф за повторение тем и концепций в тексте. Положительные значения заставляют модель избегать уже упомянутых тем, отрицательные – фокусироваться на них.',
                example: '-2.0 = активное повторение тем<br>0.0 = стандартное поведение<br>2.0 = максимальное разнообразие тем',
                type: 'warning'
            },
            'frequency-penalty': {
                title: 'Frequency Penalty',
                text: 'Штраф за частоту использования одинаковых токенов. Снижает вероятность повторения одних и тех же слов пропорционально частоте их появления в тексте.',
                example: '-2.0 = повторения слов приветствуются<br>0.0 = стандартное поведение<br>2.0 = максимально избегать повторов',
                type: 'warning'
            },
            'search-depth': {
                title: 'Глубина поиска',
                text: 'Определяет количество источников для анализа при Deep Research. Высокая глубина даёт более полные результаты, но требует больше времени.',
            ...
            'search-recency': {
                ...
                text: 'Ограничивает поиск по времени публикации. Полезно для получения актуальных новостей и избежания устаревшей информации.',
                example: 'Hour = последний час<br>Day = последние 24 часа<br>Week = последняя неделя',
                type: 'success'
            },
            'perplexity-citations': {
                title: 'Источники цитирования',
                text: 'Возвращает ссылки на источники информации. Важно для проверки фактов и обеспечения достоверности новостей.',
                example: 'Включено = ссылки на источники<br>Выключено = только текст',
                type: 'info'
            },
            'perplexity-domains': {
                title: 'Фильтр доменов',
                text: 'Приоритетные домены для поиска информации. Укажите надёжные источники юридических новостей для повышения качества контента.',
                example: 'pravo.gov.ru, consultant.ru, garant.ru',
                type: 'info'
            },
            ...
            'openai-style': {
                ...
                text: 'Визуальный стиль для DALL-E 3. Vivid создаёт яркие, насыщенные изображения. Natural даёт более реалистичные результаты.',
            ...
            'user-timezone': {
                title: 'Часовой пояс',
                text: 'Часовой пояс для планировщика задач. Все времена публикаций будут интерпретироваться в выбранном поясе.',
            ...
            'collection-time': {
                ...
                text: 'Ежедневное время запуска сбора новостей. Рекомендуется раннее утро для получения свежих новостей на весь день.',
                example: '08:30 = утренний сбор<br>06:00 = ранний сбор',
                type: 'success'
            },
            'publications-count': {
                title: 'Количество публикаций',
                text: 'Сколько новостей публиковать в день. Больше публикаций = больше охват, но выше нагрузка на аудиторию.',
            ...
            'generate-images': {
                ...
                text: 'Создавать 4-панельные комиксы для новостей. Повышает вовлечённость аудитории, но увеличивает время и стоимость.',
                example: 'Время: ~3 мин/изображение<br>Цена: $0.02-$0.19',
                type: 'warning'
            },
            'publish-without-images': {
                title: 'Публикация без изображений',
                text: 'Публиковать новости даже если генерация изображений не удалась. Обеспечивает непрерывность публикаций.',
