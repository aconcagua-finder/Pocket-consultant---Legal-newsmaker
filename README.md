...
- 🎨 **4-панельные комиксы** - визуальные истории без текста через OpenAI
...
- ⚡ **Оптимизация затрат** - quality "medium" для изображений
...
OPENAI_IMAGE_QUALITY = "medium"  # Экономия средств
OPENAI_IMAGE_SIZE = "1536x1024"  # 4-панельный формат
