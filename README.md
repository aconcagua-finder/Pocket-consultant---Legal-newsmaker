...
- **Расширенные параметры Perplexity** - фильтры свежести, глубина поиска, даты
- **Улучшенная поддержка OpenAI** - корректные размеры и качество для всех моделей
- **Динамический веб-интерфейс** - tooltips, индикаторы цен и лимитов
...
- 📅 **7 публикаций в день** - от критически важных до дополнительных
