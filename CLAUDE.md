...
- **Версия**: 2.0.1 (исправления и улучшения)
...
6. **openai_client.py** - генерация 4-панельных комиксов через GPT-Image-1
...
### Генерация комиксов (OpenAI GPT-Image-1)
- Функция: `get_openai_comic_prompt()`
- Модель: GPT-Image-1 (апрель 2025, до 4096x4096)
- 4-панельный формат без текста
- Визуальная история: обнаружение → реакция → понимание → адаптация
- Реалистичный стиль, quality "high" ($0.19 за изображение)
